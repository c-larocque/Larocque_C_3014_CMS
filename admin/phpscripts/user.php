...
function createUser($fname, $username, $password, $email, $userlvl) {
	...
	$userString = "INSERT INTO tbl_user VALUES(NULL, '{$fname}', '{$username}','{$hashPassword}', '{$email}', NULL, '{$userlvl}', NULL, 0, 0, NOW())"; //NOW() gives me the time the user was created
	//echo $userString;
...
function editUser($id, $fname, $username, $password, $email) {
	...
	$updatestring = "UPDATE tbl_user SET user_fname = '{$fname}', user_name = '{$username}', user_pass = '{$hashPassword}', user_email = '{$email}' WHERE user_id = {$id}";
	//echo $updatestring;
